...
def main() -> None:
    ...
    command = [
        ...
        '--add-data', f'{ROOT / "videos" / "published"};videos/unique',
        '--add-data', f'{ROOT / "videos" / "desktop" / "default-project.json"};videos/desktop',
        '--add-data', f'{ROOT / "videos" / "collage-editor.py"};videos',
        '--add-data', f'{ROOT / "videos" / "create-collage.py"};videos',
        '--add-data', f'{ROOT / "videos" / "collage_compositor.py"};videos',
