...
Teams override or extend these files by copying the relevant file into `.knowledge/risk-checklists/` in their consuming repo (override path takes priority during load).
